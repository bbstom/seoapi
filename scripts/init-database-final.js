 ...
 * 
 * 使用方法：
 * node scripts/init-database-final.js
 */
    ...
    const tables = [
        {
            ...
            sql: `CREATE TABLE IF NOT EXISTS users (
                ...
                default_mode VARCHAR(50) DEFAULT 'humanlike',
        ...
        },
        {
            ...
            sql: `CREATE TABLE IF NOT EXISTS node_health_logs (
                ...
                auth_error_code VARCHAR(50),
                quota_status VARCHAR(20),
                quota_total BIGINT,
                quota_used BIGINT,
